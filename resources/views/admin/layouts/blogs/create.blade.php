                ...
                <div class="card-body">
                    <form action="{{route("admin.blog.store")}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Quảng bá về category" required />
                            @error('title')
                            ...
                            <div class="card">
                                ...
                                <div class="card-body demo-vertical-spacing demo-only-element">
                                    <div class="input-group d-flex align-items-center justify-content-around">
                                        ...
                                        <img class="image-upload d-none" alt="image blog" height="200" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
