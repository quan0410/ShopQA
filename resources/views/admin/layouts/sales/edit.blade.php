                    ...
                    <form action="{{route("admin.sale.update", ['sale'=> $sale->id])}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                   value="{{$sale->title}}" name="title" placeholder="Deal hot mùa hè mới" required/>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('content') is-invalid @enderror" id="content"
                                   value="{{$sale->content}}" name="content"
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0" id="tb-products" data="{{$sale->products}}">
